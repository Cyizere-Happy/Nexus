    ...
    <main>
        <div class="auth-container">
            <div class="auth-card">
                ...
                <p class="auth-subtitle">Join the Nexus community today</p>
                <form id="signupForm" class="auth-form" action="create.php" method="post">
                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" id="username" required placeholder="Choose a username" name="username">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" required placeholder="Create a password" name="password">
                    </div>
                    <button type="submit" class="auth-button primary" name="submit">Create Account</button>
                </form>
